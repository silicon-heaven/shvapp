...
private:
	...
	shv::chainpack::RpcValue getSitesHash(const QString &shv_path) const;
	void getSitesTgz(const QString &shv_path, std::function<void(const QByteArray &, const QString &)> callback);
