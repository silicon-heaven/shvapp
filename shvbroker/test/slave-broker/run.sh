...
tmux select-pane -t0
tmux split-window -hf $BINDIR/shvagent -p 3757 -u iot --password lub42DUB --lt plain -m test/agentA1 --hbi 0 --tester -v tester
...
tmux split-window $BINDIR/shvagent -p 3755 -u iot --password lub42DUB --lt plain -m test/agent --hbi 0 --ts $TSTDIR/tests.cpon -v tester
